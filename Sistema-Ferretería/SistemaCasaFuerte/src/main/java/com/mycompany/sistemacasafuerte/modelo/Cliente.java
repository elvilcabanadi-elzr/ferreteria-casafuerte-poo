 ...
 */
public class Cliente extends Usuario implements IPersistible {
    ...
    @Override
    public void guardar() {
        System.out.println("Guardando cliente " + getNombre() + " en la base de datos...");
        // Lógica de persistencia con SQLite (se implementará en repositorio)
    }

    @Override
    public void actualizar() {
        System.out.println("Actualizando datos del cliente " + getNombre() + "...");
    }

    @Override
    public void eliminar() {
        System.out.println("Eliminando cliente " + getNombre() + " del sistema...");
    }
}
